...
```javascript
const connor = {
    education: "University of Glasgow 🏴󠁧󠁢󠁳󠁣󠁴󠁿",
...
I'm a **Computer Science student** at the **University of Glasgow** with a deep passion for **AI and technology-driven problem solving**. My journey spans from software engineering internships to hands-on experience with enterprise cloud platforms, giving me a well-rounded perspective on building scalable, impactful solutions.
...
![Genesys](https://img.shields.io/badge/Genesys_Cloud-FF4F1F?style=for-the-badge&logo=genesys&logoColor=white)
...
<table>
  <tr>
    <td>🤖</td>
    <td><strong>AI & Machine Learning</strong> - Exploring deep learning architectures and their practical applications</td>
  </tr>
  <tr>
    <td>☁️</td>
    <td><strong>Cloud Architecture</strong> - Building scalable solutions with AWS services</td>
  </tr>
  <tr>
    <td>🔧</td>
    <td><strong>Full-Stack Development</strong> - Creating end-to-end applications with modern frameworks</td>
  </tr>
  <tr>
    <td>📚</td>
    <td><strong>Continuous Learning</strong> - Always expanding my knowledge in emerging technologies</td>
  </tr>
</table>
